...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = (df[higher_education & more_than_50K].shape[0] / df[higher_education].shape[0]) * 100
    lower_education_rich = (df[lower_education & more_than_50K].shape[0] / df[lower_education].shape[0]) * 100
